...
final class Texts {
    ...
    enum LearningFlowPage {
        ...
        static let streakTitle = "Day streak"
        static let streakToday = "Today"
        static let streakSubtitle = "You extended your streak today. Keep learning tomorrow to continue the chain."
        static let skipGesture = "Skip"
        static let skipGestureTitle = "Skip gesture recognition?"
        static let skipGestureMessage = "Use this only if recognition does not work. The practice step will be marked as completed."
        static let skipGestureConfirm = "Mark as completed"
    ...
    enum CameraPage {
        ...
        static let startLiveRecognition = "Start live recognition"
        static let stopRecognition = "Stop recognition"
        static let preparingCamera = "Preparing camera..."
        static let liveAnalyzing = "Camera is streaming frames to MediaPipe."
        static let livePreview = "MediaPipe live"
        static let cameraUnavailable = "Camera unavailable"
        static let fallbackRecognition = "Run fallback recognition"
    ...
    enum SettingsPage {
        ...
        static let cameraModeValue = "MediaPipe-ready"
